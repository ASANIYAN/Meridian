...
const styles = StyleSheet.create({
  ...
  heading1: { fontSize: 20, fontFamily: 'Helvetica-Bold', marginTop: 14, marginBottom: 8 },
  heading2: { fontSize: 16, fontFamily: 'Helvetica-Bold', marginTop: 12, marginBottom: 6 },
  heading3: { fontSize: 13, fontFamily: 'Helvetica-Bold', marginTop: 10, marginBottom: 5 },
  headingRest: { fontSize: 11, fontFamily: 'Helvetica-Bold', marginTop: 8, marginBottom: 4 },
